...
<div class="container-botoes-gourmet">
    <button onclick="${adicionaisProduto.length > 0 ? funcAddConfig : funcAbrirIntermediario}" class="btn-action-main" style="background:var(--ifood-red);">
        <i class="fas fa-shopping-basket"></i> ADICIONAR
    </button>
    ${lojistaInfoCache.montarAtivo && p.permiteMontar === true ? `
